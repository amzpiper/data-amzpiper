/*
 ...
 Source Host           : 39.106.63.189:3307
...
CREATE TABLE `orders`  (
  ...
  `deflag` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
...
INSERT INTO `sys_captcha` VALUES ('26507e8e-9031-4f49-83a9-11180fe74c7e', 'gem7w', '2021-10-28 07:24:03');
INSERT INTO `sys_captcha` VALUES ('2f0fcad9-1469-41f4-8e2b-9440daeb91e7', 'n4cbg', '2021-10-28 07:47:37');
INSERT INTO `sys_captcha` VALUES ('59bd303e-8080-4611-8913-d6a52597f47c', '8f42e', '2021-10-28 07:47:42');
...
INSERT INTO `sys_captcha` VALUES ('9080d2ac-e3aa-459e-8730-a39babb01d92', 'cmg3x', '2021-10-28 07:47:32');
...
CREATE TABLE `sys_log`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 18 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '系统日志' ROW_FORMAT = Dynamic;
...
INSERT INTO `sys_log` VALUES (14, 'admin', '保存角色', 'io.renren.modules.sys.controller.SysRoleController.save()', '[{\"roleId\":1,\"roleName\":\"系统操作员\",\"remark\":\"\",\"createUserId\":1,\"menuIdList\":[2,15,16,17,18,3,19,20,21,22,31,32,33,34,35,-666666,1],\"createTime\":\"Oct 28, 2021, 3:11:32 PM\"}]', 694, '0:0:0:0:0:0:0:1', '2021-10-28 07:11:33');
INSERT INTO `sys_log` VALUES (15, 'admin', '修改用户', 'io.renren.modules.sys.controller.SysUserController.update()', '[{\"userId\":1,\"username\":\"admin\",\"salt\":\"YzcmCZNvbXocrsz9dm8e\",\"email\":\"root@admin.com\",\"mobile\":\"13161651120\",\"status\":1,\"roleIdList\":[],\"createUserId\":1}]', 108, '0:0:0:0:0:0:0:1', '2021-10-28 07:11:57');
INSERT INTO `sys_log` VALUES (16, 'admin', '保存用户', 'io.renren.modules.sys.controller.SysUserController.save()', '[{\"userId\":1453620642872401922,\"username\":\"test\",\"password\":\"f780f5e912b99575bea1492815646de3843e8de724fe235a898ffc3938ebaa99\",\"salt\":\"WqrDiuqsAT8qFucGk5y8\",\"email\":\"13161651120@qq.com\",\"mobile\":\"13161651120\",\"status\":1,\"roleIdList\":[1],\"createUserId\":1,\"createTime\":\"Oct 28, 2021, 3:12:22 PM\"}]', 172, '0:0:0:0:0:0:0:1', '2021-10-28 07:12:23');
INSERT INTO `sys_log` VALUES (17, 'admin', '修改菜单', 'io.renren.modules.sys.controller.SysMenuController.update()', '[{\"menuId\":5,\"parentId\":1,\"name\":\"SQL监控\",\"url\":\"http://localhost:8999/druid/sql.html\",\"type\":1,\"icon\":\"sql\",\"orderNum\":4}]', 339, '0:0:0:0:0:0:0:1', '2021-10-28 07:20:43');
...
INSERT INTO `sys_menu` VALUES (5, 1, 'SQL监控', 'http://localhost:8999/druid/sql.html', NULL, 1, 'sql', 4);
...
INSERT INTO `sys_menu` VALUES (35, 0, '告警信息', 'alert/alertlist', NULL, 1, 'tubiao', 1);
...
-- Records of sys_role
-- ----------------------------
INSERT INTO `sys_role` VALUES (1, '系统操作员', '', 1, '2021-10-28 07:11:33');
...
INSERT INTO `sys_role_menu` VALUES (11, 1, 31);
INSERT INTO `sys_role_menu` VALUES (12, 1, 32);
INSERT INTO `sys_role_menu` VALUES (13, 1, 33);
INSERT INTO `sys_role_menu` VALUES (14, 1, 34);
INSERT INTO `sys_role_menu` VALUES (15, 1, 35);
INSERT INTO `sys_role_menu` VALUES (16, 1, -666666);
INSERT INTO `sys_role_menu` VALUES (17, 1, 1);
...
) ENGINE = InnoDB AUTO_INCREMENT = 1453620642872401923 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '系统用户' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES (1, 'admin', 'df42fc72c8c8edccd03edd5f128ff8827af4101dbc8f85e735f9f2c5cfe074d2', 'YzcmCZNvbXocrsz9dm8e', 'root@admin.com', '13161651120', 1, 1, '2016-11-11 11:11:11');
INSERT INTO `sys_user` VALUES (1453620642872401922, 'test', 'f780f5e912b99575bea1492815646de3843e8de724fe235a898ffc3938ebaa99', 'WqrDiuqsAT8qFucGk5y8', '13161651120@qq.com', '13161651120', 1, 1, '2021-10-28 07:12:23');
...
CREATE TABLE `sys_user_role`  (
  ...
  `role_id` bigint(20) NULL DEFAULT NULL COMMENT '角色ID',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1453620643195363330 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '用户与角色对应关系' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of sys_user_role
-- ----------------------------
INSERT INTO `sys_user_role` VALUES (1453620643195363329, 1453620642872401922, 1);
...
-- ----------------------------
INSERT INTO `sys_user_token` VALUES (1, 'fbdd3bcbfa5a8192bc205ff1a7859cb0', '2021-10-28 19:09:32', '2021-10-28 07:09:32');
INSERT INTO `sys_user_token` VALUES (1453620642872401922, '3f4551ddbe72a50a397ffc194ee1d21f', '2021-10-28 19:45:19', '2021-10-28 07:45:19');
